...
- [chasefleming/elem-go](https://github.com/chasefleming/elem-go) ([v0.21.0](https://github.com/chasefleming/elem-go/releases/tag/v0.21.0), 1 day ago) - Type-safe Go library for creating and manipulating HTML elements (with htmx helpers).
- [ogen-go/ogen](https://github.com/ogen-go/ogen) ([v0.82.0](https://github.com/ogen-go/ogen/releases/tag/v0.82.0), 3 days ago) - OpenAPI v3 code generator for go
