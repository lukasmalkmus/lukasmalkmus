...
- [goreleaser/goreleaser](https://github.com/goreleaser/goreleaser) ([v0.166.1](https://github.com/goreleaser/goreleaser/releases/tag/v0.166.1), today) - Deliver Go binaries as fast and easily as possible
- [lukasmalkmus/icloud-go](https://github.com/lukasmalkmus/icloud-go) ([v0.1.0](https://github.com/lukasmalkmus/icloud-go/releases/tag/v0.1.0), 1 day ago) - Go client library for the CloudKit Web Services API.
