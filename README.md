...
- [golangci/golangci-lint-action](https://github.com/golangci/golangci-lint-action) ([v2.5.2](https://github.com/golangci/golangci-lint-action/releases/tag/v2.5.2), today) - Official GitHub action for golangci-lint from it&#39;s authors
...
- [axiomhq/cli](https://github.com/axiomhq/cli) ([v0.2.0](https://github.com/axiomhq/cli/releases/tag/v0.2.0), 6 days ago) - The power of Axiom on the command line.
