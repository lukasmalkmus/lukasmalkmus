...
- [charmbracelet/fantasy](https://github.com/charmbracelet/fantasy) ([v0.28.0](https://github.com/charmbracelet/fantasy/releases/tag/v0.28.0), 2 days ago) - Build AI agents with Go. Multiple providers, multiple models, one API. 🧙
- [lukasmalkmus/1nitetent](https://github.com/lukasmalkmus/1nitetent) ([v0.5.2](https://github.com/lukasmalkmus/1nitetent/releases/tag/v0.5.2), 3 days ago) - Agent-native CLI for 1nitetent.com campgrounds
- [lukasmalkmus/pngx](https://github.com/lukasmalkmus/pngx) ([v0.10.1](https://github.com/lukasmalkmus/pngx/releases/tag/v0.10.1), 3 days ago) - AI-native CLI for Paperless-ngx
...
- [lukasmalkmus/moneymoney](https://github.com/lukasmalkmus/moneymoney) ([v0.6.0](https://github.com/lukasmalkmus/moneymoney/releases/tag/v0.6.0), 5 days ago) - Agent-native CLI (mm) and MCP server for MoneyMoney
