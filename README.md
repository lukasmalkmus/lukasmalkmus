...
- [home-assistant/core](https://github.com/home-assistant/core) ([2026.5.1](https://github.com/home-assistant/core/releases/tag/2026.5.1), 2 days ago) - :house_with_garden: Open source home automation that puts local control and privacy first.
- [charmbracelet/fantasy](https://github.com/charmbracelet/fantasy) ([v0.23.1](https://github.com/charmbracelet/fantasy/releases/tag/v0.23.1), 2 days ago) - Build AI agents with Go. Multiple providers, multiple models, one API. 🧙
- [vercel-labs/agent-browser](https://github.com/vercel-labs/agent-browser) ([v0.27.0](https://github.com/vercel-labs/agent-browser/releases/tag/v0.27.0), 3 days ago) - Browser automation CLI for AI agents
