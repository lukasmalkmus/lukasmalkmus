...
- [lukasmalkmus/cwa-qr](https://github.com/lukasmalkmus/cwa-qr) ([v0.1.0](https://github.com/lukasmalkmus/cwa-qr/releases/tag/v0.1.0), 1 day ago) - Generate QR-Codes for checking into events using the official Corona Warn App.
