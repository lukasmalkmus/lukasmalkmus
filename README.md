...
- [ogen-go/ogen](https://github.com/ogen-go/ogen) ([v0.83.0](https://github.com/ogen-go/ogen/releases/tag/v0.83.0), 2 days ago) - OpenAPI v3 code generator for go
- [chasefleming/elem-go](https://github.com/chasefleming/elem-go) ([v0.23.0](https://github.com/chasefleming/elem-go/releases/tag/v0.23.0), 3 days ago) - Type-safe Go library for creating and manipulating HTML elements (with htmx helpers).
