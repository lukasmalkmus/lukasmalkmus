...
- [chasefleming/elem-go](https://github.com/chasefleming/elem-go) ([v0.30.0](https://github.com/chasefleming/elem-go/releases/tag/v0.30.0), 3 days ago) - Type-safe Go library for creating and manipulating HTML elements (with htmx helpers).
- [ogen-go/ogen](https://github.com/ogen-go/ogen) ([v1.6.0](https://github.com/ogen-go/ogen/releases/tag/v1.6.0), 1 week ago) - OpenAPI v3 code generator for go
