...
- [charmbracelet/fantasy](https://github.com/charmbracelet/fantasy) ([v0.17.0](https://github.com/charmbracelet/fantasy/releases/tag/v0.17.0), today) - Build AI agents with Go. Multiple providers, multiple models, one API. 🧙
- [vercel-labs/agent-browser](https://github.com/vercel-labs/agent-browser) ([v0.22.1](https://github.com/vercel-labs/agent-browser/releases/tag/v0.22.1), today) - Browser automation CLI for AI agents
