...
- [home-assistant/core](https://github.com/home-assistant/core) ([2026.8.0b0](https://github.com/home-assistant/core/releases/tag/2026.8.0b0), today) - :house_with_garden: Open source home automation that puts local control and privacy first.
- [charmbracelet/fantasy](https://github.com/charmbracelet/fantasy) ([v0.38.2](https://github.com/charmbracelet/fantasy/releases/tag/v0.38.2), today) - Build AI agents with Go. Multiple providers, multiple models, one API. 🧙
- [vercel-labs/agent-browser](https://github.com/vercel-labs/agent-browser) ([v0.33.1](https://github.com/vercel-labs/agent-browser/releases/tag/v0.33.1), 1 day ago) - Browser automation CLI for AI agents
