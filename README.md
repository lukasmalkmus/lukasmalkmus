...
- [vercel-labs/agent-browser](https://github.com/vercel-labs/agent-browser) ([v0.18.0](https://github.com/vercel-labs/agent-browser/releases/tag/v0.18.0), 1 day ago) - Browser automation CLI for AI agents
- [charmbracelet/fantasy](https://github.com/charmbracelet/fantasy) ([v0.12.2](https://github.com/charmbracelet/fantasy/releases/tag/v0.12.2), 1 day ago) - Build AI agents with Go. Multiple providers, multiple models, one API 🧙
