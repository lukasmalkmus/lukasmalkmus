...
- [home-assistant/core](https://github.com/home-assistant/core) ([2026.8.0b5](https://github.com/home-assistant/core/releases/tag/2026.8.0b5), 1 day ago) - :house_with_garden: Open source home automation that puts local control and privacy first.
- [vercel-labs/agent-browser](https://github.com/vercel-labs/agent-browser) ([v0.33.2](https://github.com/vercel-labs/agent-browser/releases/tag/v0.33.2), 3 days ago) - Browser automation CLI for AI agents
- [charmbracelet/fantasy](https://github.com/charmbracelet/fantasy) ([v0.40.0](https://github.com/charmbracelet/fantasy/releases/tag/v0.40.0), 5 days ago) - Build AI agents with Go. Multiple providers, multiple models, one API. 🧙
