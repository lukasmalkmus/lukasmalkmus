...
- [lukasmalkmus/rpi_exporter](https://github.com/lukasmalkmus/rpi_exporter) ([v0.9.0-rc.0](https://github.com/lukasmalkmus/rpi_exporter/releases/tag/v0.9.0-rc.0), 3 days ago) - A Raspberry Pi CPU temperature exporter.
- [axiomhq/axiom-lambda-extension](https://github.com/axiomhq/axiom-lambda-extension) ([v11](https://github.com/axiomhq/axiom-lambda-extension/releases/tag/v11), 6 days ago) - Ingest logs and platform events from your lambda functions
