...
- [charmbracelet/fantasy](https://github.com/charmbracelet/fantasy) ([v0.18.0](https://github.com/charmbracelet/fantasy/releases/tag/v0.18.0), 1 day ago) - Build AI agents with Go. Multiple providers, multiple models, one API. 🧙
- [vercel-labs/agent-browser](https://github.com/vercel-labs/agent-browser) ([v0.25.4](https://github.com/vercel-labs/agent-browser/releases/tag/v0.25.4), 4 days ago) - Browser automation CLI for AI agents
- [home-assistant/core](https://github.com/home-assistant/core) ([2026.4.2](https://github.com/home-assistant/core/releases/tag/2026.4.2), 5 days ago) - :house_with_garden: Open source home automation that puts local control and privacy first.
