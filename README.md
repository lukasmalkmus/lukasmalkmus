...
- [home-assistant/core](https://github.com/home-assistant/core) ([2026.1.2](https://github.com/home-assistant/core/releases/tag/2026.1.2), 1 week ago) - :house_with_garden: Open source home automation that puts local control and privacy first.
...
- [charmbracelet/fantasy](https://github.com/charmbracelet/fantasy) ([v0.6.1](https://github.com/charmbracelet/fantasy/releases/tag/v0.6.1), 1 week ago) - Build AI agents with Go. Multiple providers, multiple models, one API 🧙
- [axiomhq/axiom-go](https://github.com/axiomhq/axiom-go) ([v0.27.0](https://github.com/axiomhq/axiom-go/releases/tag/v0.27.0), 4 weeks ago) - Official Go bindings for the Axiom API
